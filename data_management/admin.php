...
{
	global $link;
	$target_dir = "imgs/"; // The directory where you want to save the uploaded images
...
// if everything is ok, try to upload file
	...
	if ($_POST['name'] != '' && $_POST['stock'] != '' && $_POST['price'] != '')
	{
		...
		{
			$query = 'INSERT INTO `itm` (`name`, `stock`, `price`,`photo` ) VALUES ("'.$_POST['name'].'", "'.$_POST['stock'].'", "'.$_POST['price'].'", "'.$target_file_db.'")';
			mysqli_query($link, $query);
			if ($_POST['category'] != '')
			{
